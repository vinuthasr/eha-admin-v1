...
export class AddProductsComponent implements OnInit {
  ...
  validation(data) {
    ...
    this.addproduct.subImageList[0].imagePath = data.imagePath1;
    this.addproduct.subImageList[1].imagePath = data.imagePath2;
    this.addproduct.subImageList[2].imagePath = data.imagePath3;
    this.addproduct.subImageList[3].imagePath = data.imagePath4;
